...
# Change this value for your own deployment.
...
def verify_2fa():
    ...
    if request.method == "POST":
        ...
        if not otp.isdigit() or len(otp) != 6:
            flash("Enter a valid 6-digit verification code.")
...
def enable_2fa():
    ...
    # Store secret temporarily so it can be displayed once
    session["new_2fa_secret"] = secret

    flash(
        "2FA enabled. Save your secret key in an authenticator app."
    )
